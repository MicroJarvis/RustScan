...
use rustscan_slam::core::SE3;
use rustscan_slam::fusion::{GaussianMapper, MeshExtractionConfig, MeshExtractor, TsdfConfig};
use rustscan_slam::io::{Dataset, DatasetConfig, TumRgbdDataset};
use rustscan_slam::tracker::{VOState, VisualOdometry};
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Configuration
    let dataset_path = PathBuf::from("../artifacts/inputs/tum/rgbd_dataset_freiburg1_xyz");
    let output_dir = PathBuf::from("../artifacts/runs/test_output_tum");
