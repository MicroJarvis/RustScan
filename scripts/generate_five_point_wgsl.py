...
Array indices and expression evaluation order are preserved. Unsupported syntax,
...
def polynomial_table(source):
    ...
    Keeps every multiply and add/subtract in source order. Avoids pathological
    Metal optimization of the fully expanded determinant expression DAG.
    """
