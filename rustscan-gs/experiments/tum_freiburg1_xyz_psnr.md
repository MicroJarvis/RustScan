...
Dataset: `/Users/tfjiang/Projects/RustScan/artifacts/inputs/tum_freiburg1_xyz_colmap`
...
cargo run --release -p rustscan-gs --bin rustgs -- train \
  ...
  --output rustscan-gs/output/experiments/tum_psnr/baseline_500.ply \
  --iterations 500 \
  --eval-after-train \
  --eval-json \
  --log-level info
...
cargo run --release -p rustscan-gs --bin rustgs -- train \
  --input /Users/tfjiang/Projects/RustScan/artifacts/inputs/tum_freiburg1_xyz_colmap \
  --output rustscan-gs/output/experiments/tum_psnr/baseline_1000.ply \
  --iterations 1000 \
  --eval-after-train \
  --eval-json \
  --log-level info
...
cargo run --release -p rustscan-gs --bin rustgs -- train \
  --input /Users/tfjiang/Projects/RustScan/artifacts/inputs/tum_freiburg1_xyz_colmap \
  --output rustscan-gs/output/experiments/tum_psnr/alpha_eval_500.ply \
  --iterations 500 \
  --eval-after-train \
  --eval-json \
  --log-level info
...
cargo run --release -p rustscan-gs --bin rustgs -- train \
  --input /Users/tfjiang/Projects/RustScan/artifacts/inputs/tum_freiburg1_xyz_colmap \
  --output rustscan-gs/output/experiments/tum_psnr/alpha_eval_1000.ply \
  --iterations 1000 \
  --eval-after-train \
  --eval-json \
  --log-level info
...
cargo run --release -p rustscan-gs --bin rustgs -- train \
  --input /Users/tfjiang/Projects/RustScan/artifacts/inputs/tum_freiburg1_xyz_colmap \
  --output rustscan-gs/output/experiments/tum_psnr/alpha_eval_3000.ply \
  --iterations 3000 \
  --eval-after-train \
  --eval-json \
  --log-level info
...
cargo run --release -p rustscan-gs --bin rustgs -- train \
  --input /Users/tfjiang/Projects/RustScan/artifacts/inputs/tum_freiburg1_xyz_colmap \
  --output rustscan-gs/output/experiments/tum_psnr/shader_matched_eval_1000.ply \
  --iterations 1000 \
  --eval-after-train \
  --eval-json \
  --log-level info
...
```sh
cargo run --release -p rustscan-gs --example evaluate_psnr -- \
  --scene rustscan-gs/output/experiments/tum_psnr/alpha_eval_3000.ply \
  --dataset /Users/tfjiang/Projects/RustScan/artifacts/inputs/tum_freiburg1_xyz_colmap \
  --render-scale 0.25 \
  --max-frames 180 \
  --frame-stride 30 \
...
cargo run --release -p rustscan-gs --bin rustgs -- train \
  --input /Users/tfjiang/Projects/RustScan/artifacts/inputs/tum_freiburg1_xyz_colmap \
  --output rustscan-gs/output/experiments/tum_psnr/final_30000_freeze_epoch4.ply \
  --iterations 30000 \
