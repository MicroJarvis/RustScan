...
/// Compatibility alias for the old `rustscan_gs::io::TrainingCheckpoint` path.
#[deprecated(
    note = "use rustscan_gs::LegacyTrainingCheckpoint for JSON snapshots or rustscan_gs::TrainingCheckpoint for resumable checkpoints"
)]
