...
//!
//! ```no_run
//! use rustscan_gs::{load_colmap_training_dataset, train_splats, ColmapConfig, TrainingConfig, TrainingOptions};
...
//!     "scene.ply".as_ref(),
//!     &run.splats,
//!     &rustscan_gs::SplatMetadata::default(),
//! )?;
//! # Ok(())
//! # }
//! ```
...
pub use crate::training::{
    ...
    load_optimization_report, load_training_checkpoint, load_training_checkpoint_with_migration,
