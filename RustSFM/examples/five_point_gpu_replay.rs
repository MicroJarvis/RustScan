...
fn main() -> Result<()> {
    ...
    for batch in [64, 512] {
        ...
        reports.push(json!({"batch":batch,"warmup_seconds":{"serial":serial_warmup,"threads4":parallel_warmup,"gpu":gpu_warmup},"gpu_exact_across_batches":batch_exact,"rounds":rounds,"comparison":comparison}));
    }
