...
1. Bundle adjustment / Ceres layer (`P5`, ~79%) — largest numerical-parity
   ...
   - Done: Ceres robust loss family (Trivial/Huber/SoftL1/Cauchy) with COLMAP's
     ...
     native projection code, and exact COLMAP ambient Jacobians for image,
     frame, and sensor pose residual blocks.
