...
1. Bundle adjustment / Ceres layer (`P5`, ~76%) — largest numerical-parity
   ...
   - Next: migrate active BA pose storage to the new COLMAP-style
     quaternion+translation Ceres manifolds, jacobian-scaled LM damping /
