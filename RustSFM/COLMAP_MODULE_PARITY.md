...
1. Bundle adjustment / Ceres layer (`P5`, ~77%) — largest numerical-parity
   ...
   - Done: Ceres robust loss family (Trivial/Huber/SoftL1/Cauchy) with COLMAP's
     ...
     intrinsics blocks, gauges, and analytic point/camera Jacobians reused from
     native projection code.
   - Next: exact analytic ambient Jacobians for Ceres pose manifolds,
