...
- [`rustscan-sfm/output/pair_profile_flowers24/report.md`](output/pair_profile_flowers24/report.md)
- [`rustscan-sfm/output/sift_distance_kernel/`](output/sift_distance_kernel/)
- [`rustscan-sfm/output/taskflow_feature_profile_check_fixed.json`](output/taskflow_feature_profile_check_fixed.json)
- [`rustscan-sfm/output/taskflow_vlfeat_stage_profile_check.json`](output/taskflow_vlfeat_stage_profile_check.json)
- [`rustscan-sfm/output/taskflow_feature_profile_baseline_seed1_run1.json`](output/taskflow_feature_profile_baseline_seed1_run1.json)
- [`rustscan-sfm/output/taskflow_feature_profile_baseline_seed1_run2.json`](output/taskflow_feature_profile_baseline_seed1_run2.json)
- [`rustscan-sfm/output/taskflow_feature_profile_baseline_seed1_run3.json`](output/taskflow_feature_profile_baseline_seed1_run3.json)
- [`rustscan-sfm/output/taskflow_feature_profile_quantized_seed1_run1.json`](output/taskflow_feature_profile_quantized_seed1_run1.json)
- [`rustscan-sfm/output/taskflow_feature_profile_quantized_seed1_run2.json`](output/taskflow_feature_profile_quantized_seed1_run2.json)
- [`rustscan-sfm/output/taskflow_feature_profile_quantized_seed1_run3.json`](output/taskflow_feature_profile_quantized_seed1_run3.json)
- [`rustscan-sfm/src/feature/sift_index.rs`](src/feature/sift_index.rs)
- [`rustscan-sfm/examples/sift_search_bench.rs`](examples/sift_search_bench.rs)
...
在 `rustscan-sfm/src/sfm/mapper/image_features.rs` 和必要的图像加载路径中，增加默认关闭的阶段计时：
...
```sh
cargo test -p rustscan-sfm --release --offline --lib sift::tests::vlfeat_profiling_preserves_feature_bits -- --nocapture
cargo build -p rustscan-sfm --release --offline --bin rustsfm
cargo test -p rustscan-sfm --release --offline --lib sift::tests:: -- --nocapture
cargo test -p rustscan-sfm --release --offline --lib -- --skip gpu::
cargo check -p rustscan-sfm --release --offline --no-default-features --all-targets
# Header-only dirty/rebuild proof; full log linked above:
touch third_party/native/vlfeat/float.h
cargo test -p rustscan-sfm --release --offline --lib sift::tests::vlfeat_profiling_preserves_feature_bits -vv -- --nocapture
```
...
```sh
python3 rustscan-sfm/tools/test_vlfeat_native.py
python3 rustscan-sfm/tools/test_vlfeat_native.py --sanitize
rustfmt --check --edition 2021 rustscan-sfm/build.rs rustscan-sfm/src/feature/sift.rs
git diff --check
...
```sh
cargo build -p rustscan-sfm --release --offline --bin rustsfm
cp -p target/release/rustsfm rustscan-sfm/output/neon_corrected_baseline_bin
shasum -a 256 target/release/rustsfm rustscan-sfm/output/neon_corrected_baseline_bin
cargo test -p rustscan-sfm --release --offline --lib sift::tests::vlfeat_profiling_preserves_feature_bits -- --nocapture
# Above precedes production edits; after native correctness, repeat fixed-hash test and build:
cargo test -p rustscan-sfm --release --offline --lib sift::tests::vlfeat_profiling_preserves_feature_bits -- --nocapture
cargo build -p rustscan-sfm --release --offline --bin rustsfm
cp -p target/release/rustsfm rustscan-sfm/output/neon_corrected_candidate_bin
shasum -a 256 rustscan-sfm/output/neon_corrected_baseline_bin rustscan-sfm/output/neon_corrected_candidate_bin
# After six Flowers runs:
cargo test -p rustscan-sfm --release --offline --lib sift::tests:: -- --nocapture
cargo test -p rustscan-sfm --release --offline --lib -- --skip gpu::
cargo check -p rustscan-sfm --release --offline --no-default-features --all-targets
cargo build -p rustscan-sfm --release --offline --bin rustsfm
shasum -a 256 target/release/rustsfm rustscan-sfm/output/neon_corrected_candidate_bin
```
...
python3 rustscan-sfm/tools/test_vlfeat_native.py
python3 rustscan-sfm/tools/test_vlfeat_native.py --sanitize
python3 rustscan-sfm/tools/test_vlfeat_native.py --ubsan
clang -O3 -DNDEBUG -DVL_DISABLE_AVX -DVL_DISABLE_SSE2 -DVL_DISABLE_OPENMP -I third_party/native/vlfeat -S rustscan-sfm/tools/vlfeat_imconv_scalar.c -o rustscan-sfm/output/neon_corrected_scalar.s
clang -O3 -DNDEBUG -DVL_DISABLE_AVX -DVL_DISABLE_SSE2 -DVL_DISABLE_OPENMP -I third_party/native/vlfeat -S third_party/native/vlfeat/imopv.c -o rustscan-sfm/output/neon_corrected_candidate.s
grep -n -E 'fmadd|fmla' rustscan-sfm/output/neon_corrected_scalar.s rustscan-sfm/output/neon_corrected_candidate.s
rustfmt --check --edition 2021 rustscan-sfm/build.rs rustscan-sfm/src/feature/sift.rs
git diff --check
```
...
```sh
RUSTSFM_PROFILE_FEATURES=1 RUSTSFM_PROFILE_PAIRS=1 VECLIB_MAXIMUM_THREADS=1 OPENBLAS_NUM_THREADS=1 OMP_NUM_THREADS=1 /usr/bin/time -l rustscan-sfm/output/neon_corrected_baseline_bin reconstruct --input artifacts/inputs/flowers/images --output rustscan-sfm/output/neon_corrected_b1 --max-images 24 --max-features 8192 --local-matching --random-seed 1 --summary-json rustscan-sfm/output/neon_corrected_b1.json > rustscan-sfm/output/neon_corrected_b1.log 2>&1
RUSTSFM_PROFILE_FEATURES=1 RUSTSFM_PROFILE_PAIRS=1 VECLIB_MAXIMUM_THREADS=1 OPENBLAS_NUM_THREADS=1 OMP_NUM_THREADS=1 /usr/bin/time -l rustscan-sfm/output/neon_corrected_candidate_bin reconstruct --input artifacts/inputs/flowers/images --output rustscan-sfm/output/neon_corrected_c1 --max-images 24 --max-features 8192 --local-matching --random-seed 1 --summary-json rustscan-sfm/output/neon_corrected_c1.json > rustscan-sfm/output/neon_corrected_c1.log 2>&1
RUSTSFM_PROFILE_FEATURES=1 RUSTSFM_PROFILE_PAIRS=1 VECLIB_MAXIMUM_THREADS=1 OPENBLAS_NUM_THREADS=1 OMP_NUM_THREADS=1 /usr/bin/time -l rustscan-sfm/output/neon_corrected_baseline_bin reconstruct --input artifacts/inputs/flowers/images --output rustscan-sfm/output/neon_corrected_b2 --max-images 24 --max-features 8192 --local-matching --random-seed 1 --summary-json rustscan-sfm/output/neon_corrected_b2.json > rustscan-sfm/output/neon_corrected_b2.log 2>&1
RUSTSFM_PROFILE_FEATURES=1 RUSTSFM_PROFILE_PAIRS=1 VECLIB_MAXIMUM_THREADS=1 OPENBLAS_NUM_THREADS=1 OMP_NUM_THREADS=1 /usr/bin/time -l rustscan-sfm/output/neon_corrected_candidate_bin reconstruct --input artifacts/inputs/flowers/images --output rustscan-sfm/output/neon_corrected_c2 --max-images 24 --max-features 8192 --local-matching --random-seed 1 --summary-json rustscan-sfm/output/neon_corrected_c2.json > rustscan-sfm/output/neon_corrected_c2.log 2>&1
RUSTSFM_PROFILE_FEATURES=1 RUSTSFM_PROFILE_PAIRS=1 VECLIB_MAXIMUM_THREADS=1 OPENBLAS_NUM_THREADS=1 OMP_NUM_THREADS=1 /usr/bin/time -l rustscan-sfm/output/neon_corrected_baseline_bin reconstruct --input artifacts/inputs/flowers/images --output rustscan-sfm/output/neon_corrected_b3 --max-images 24 --max-features 8192 --local-matching --random-seed 1 --summary-json rustscan-sfm/output/neon_corrected_b3.json > rustscan-sfm/output/neon_corrected_b3.log 2>&1
RUSTSFM_PROFILE_FEATURES=1 RUSTSFM_PROFILE_PAIRS=1 VECLIB_MAXIMUM_THREADS=1 OPENBLAS_NUM_THREADS=1 OMP_NUM_THREADS=1 /usr/bin/time -l rustscan-sfm/output/neon_corrected_candidate_bin reconstruct --input artifacts/inputs/flowers/images --output rustscan-sfm/output/neon_corrected_c3 --max-images 24 --max-features 8192 --local-matching --random-seed 1 --summary-json rustscan-sfm/output/neon_corrected_c3.json > rustscan-sfm/output/neon_corrected_c3.log 2>&1
```
...
```sh
VECLIB_MAXIMUM_THREADS=1 OPENBLAS_NUM_THREADS=1 OMP_NUM_THREADS=1 \
  cargo build -p rustscan-sfm --release --bin rustsfm --offline
```
...
VECLIB_MAXIMUM_THREADS=1 OPENBLAS_NUM_THREADS=1 OMP_NUM_THREADS=1 \
  ...
  --output rustscan-sfm/output/<unique-run-dir> \
  --max-images 24 \
  --max-features 8192 \
  --local-matching \
  --summary-json rustscan-sfm/output/<unique-summary>.json
```
...
```sh
VECLIB_MAXIMUM_THREADS=1 OPENBLAS_NUM_THREADS=1 OMP_NUM_THREADS=1 \
  cargo test -p rustscan-sfm --release --lib --offline -- --skip gpu::

VECLIB_MAXIMUM_THREADS=1 OPENBLAS_NUM_THREADS=1 OMP_NUM_THREADS=1 \
  cargo check -p rustscan-sfm --release --no-default-features --all-targets --offline
```
