...
//! (`rustscan_slam::ColmapMt19937`) so a fixed `random_seed` yields a reproducible
...
mod tests {
    ...
    fn make_blobs(dim: usize, per_blob: usize) -> (Vec<f32>, Vec<usize>) {
        let centers = [(0usize, 10.0f32), (1, 10.0), (2, 10.0), (3, 10.0)];
    ...
    fn generate_vocab_tree_pairs_excludes_self_and_dedups() {
        ...
        let pairs =
            generate_vocab_tree_pairs(&index, &queries, dim, &VocabTreePairOptions::default());
