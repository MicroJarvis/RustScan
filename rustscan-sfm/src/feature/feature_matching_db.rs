...
pub fn debug_two_view_database_pair(
    ...
    let matches = db
        ...
        .into_iter()
        .map(Into::into)
        .collect::<Vec<rustscan_slam::Match>>();
...
type PairReportInput = (
    usize,
    usize,
    Vec<rustscan_slam::Match>,
    Option<PairGeometry>,
);
...
fn computed_match_pair_reports_for_inputs(
    ...
    #[cfg(feature = "gpu-wgpu")]
    {
        ...
        let pregenerate = |left: usize, right: usize, matches: &[rustscan_slam::Match]| {
...
type ExistingMatchPairInput = (usize, usize, Vec<rustscan_slam::Match>);
...
fn cap_guided_densify_matches(
    guided: Vec<rustscan_slam::Match>,
    densified_inliers: Vec<rustscan_slam::Match>,
    baseline_inliers: usize,
) -> (Vec<rustscan_slam::Match>, Vec<rustscan_slam::Match>) {
    ...
    let mut extras: Vec<rustscan_slam::Match> = guided
        .into_iter()
...
fn sort_matches_by_descriptor_distance(matches: &mut [rustscan_slam::Match]) {
    matches.sort_by(|a, b| {
        a.distance
...
mod tests {
    ...
    fn densify_match(query_idx: u32, distance: f32) -> rustscan_slam::Match {
        rustscan_slam::Match {
            query_idx,
            train_idx: query_idx,
            distance,
