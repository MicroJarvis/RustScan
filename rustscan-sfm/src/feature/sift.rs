...
use rayon::prelude::*;
use rustscan_slam::{KeyPoint, Match};
...
mod tests {
    ...
    fn guided_matching_filters_by_epipolar_line_before_ratio_test() {
        let left = SiftFeatures {
            keypoints: vec![rustscan_slam::KeyPoint::new(100.0, 120.0)],
        ...
        let right = SiftFeatures {
            keypoints: vec![
                rustscan_slam::KeyPoint::new(140.0, 120.0),
                rustscan_slam::KeyPoint::new(500.0, 400.0),
            ],
