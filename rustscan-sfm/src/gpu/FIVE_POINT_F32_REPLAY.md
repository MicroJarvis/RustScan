...
cargo test -p rustscan-sfm --example five_point_gpu_replay --no-default-features --features gpu-wgpu
```
...
```sh
cargo build -p rustscan-sfm --release --example five_point_gpu_replay --no-default-features --features gpu-wgpu
