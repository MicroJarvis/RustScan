...
pub(crate) fn select_best_focal_support(
    supports: &[rustscan_slam::tracker::PnPModelSupport],
) -> Option<usize> {
    supports
        .iter()
        .enumerate()
...
pub(crate) struct WgpuPnPFocalScorer {
    ...
    last_supports: Vec<rustscan_slam::tracker::PnPModelSupport>,
}
...
impl WgpuPnPFocalScorer {
    ...
    pub(crate) fn score(
        &mut self,
        candidate: GpuPnpFocalCandidate,
    ) -> Result<rustscan_slam::tracker::PnPModelSupport> {
    ...
    pub(crate) fn score_many(
    ...
    ) -> Result<Vec<rustscan_slam::tracker::PnPModelSupport>> {
        ...
        let supports = self
            ...
            .map(|(index, support)| {
                ...
                Ok(rustscan_slam::tracker::PnPModelSupport {
                    inliers: support.inliers as usize,
    ...
    fn score_generated_models_and_select(
        ...
        Option<(
            ...
            rustscan_slam::tracker::PnPModelSupport,
            Vec<bool>,
        )>,
    > {
        let image_buffer = self
        ...
        let support = rustscan_slam::tracker::PnPModelSupport {
