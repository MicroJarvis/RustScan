...
use rustscan_slam::loop_closing::detector::compute_sim3_from_matches;
use std::fmt;
...
fn estimate_sim3_robust(
    ...
    let mut best: Option<rustscan_slam::loop_closing::detector::Sim3> = None;
...
fn sim3_inliers(
    src: &[[f32; 3]],
    tgt: &[[f32; 3]],
    model: &rustscan_slam::loop_closing::detector::Sim3,
    max_error_sq: f64,
) -> Vec<usize> {
