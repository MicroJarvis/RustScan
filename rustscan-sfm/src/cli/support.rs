...
use rustscan_sfm::colmap::ColmapSparseFormat;
use rustscan_sfm::feature_matching::MatchingPairStrategy;
use rustscan_sfm::sift::{SiftExtractionOptions, SiftMatchingOptions};
...
pub(super) fn format_mask_overlap(
    overlap: &rustscan_sfm::two_view::TwoViewMaskOverlapDiagnostics,
) -> String {
    format!(
        "{}/{}@{:.3}",
