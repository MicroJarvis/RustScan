...
c++ -std=c++17 -O2 -DNDEBUG \
  ...
  rustscan-sfm/tools/colmap_trace_probe/colmap_trace_probe.cpp \
...
/tmp/colmap_trace_probe \
  --database artifacts/runs/rustsfm_flowers2_cam_rays_full_lo/database.db \
  --image1 frame_0002.jpg \
  --image2 frame_0018.jpg \
  --random-seed 0 \
  > artifacts/runs/rustsfm_flowers2_colmap_probe/colmap_0002_0018_seed0.json
```
