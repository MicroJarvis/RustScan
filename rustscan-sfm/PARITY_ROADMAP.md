...
- [x] Versioned source and opt-in CI provisioning for `artifacts/inputs/flowers2_colmap`
  ...
  - 2026-09-10: reference text committed under
    `artifacts/inputs/fixtures/flowers2_colmap_ref_text_20260630`; provision defaults
  ...
  - 2026-09-17 remeasure after initial-pair early-stop and failure
    ...
    pre-init-change snapshot in `artifacts/runs/p0_baseline_20260917/REPORT.md`.
...
- A fixed-seed, single-model 60-image home slice showed that trigger frequency
  ...
  scheduled BA at two rounds and 15 iterations reduced wall time from 74.9s to
  42.6s (43%) while keeping all 60 images registered; points changed from
  23,510 to 24,954 (+6.1%), observations from 124,419 to 125,937 (+1.2%),
  and mean reprojection error from 1.157px to 1.079px. Initial and final BA
...
(`artifacts/runs/rustsfm_flowers2_fifo_models_replay_run7_fivepoint_eigen/database.db`)
