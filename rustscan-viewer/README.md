...
```bash
cargo run -p rustscan-viewer
cargo build -p rustscan-viewer --release
cargo test -p rustscan-viewer --all-targets
```
...
- [RustSFM overview](../rustscan-sfm/README.md)
- [RustGS overview](../rustscan-gs/README.md)
