...
impl Default for CompatibilityRecord {
    fn default() -> Self {
        Self {
            ...
            rustgs_checkpoint_version: rustscan_gs::TRAINING_CHECKPOINT_VERSION,
        }
    }
}
...
pub struct SfmConfigSnapshot {
    ...
    #[serde(default)]
    pub adaptive_keyframes: rustscan_sfm::AdaptiveKeyframeSelectionConfig,
...
impl Default for SfmConfigSnapshot {
    fn default() -> Self {
        Self {
            ...
            adaptive_keyframes: rustscan_sfm::AdaptiveKeyframeSelectionConfig::default(),
            use_all_images: true,
...
pub struct ProjectManifest {
    ...
    pub training_config: rustscan_gs::TrainingConfig,
...
impl ProjectManifest {
    ...
    fn new_at(display_name: String, source: SourceSpec, id: Uuid, now_unix_ms: u64) -> Self {
        ...
        Self {
            ...
            training_config: rustscan_gs::TrainingConfig::default(),
            stages,
            active_scene: None,
            final_scene: None,
